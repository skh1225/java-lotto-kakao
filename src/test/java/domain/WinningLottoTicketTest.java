...
public class WinningLottoTicketTest {
	...
	void 로또_티켓들에대한_당첨_결과를_출력할_수_있다() {
		WinningLottoTicket winningLottoTicket = new WinningLottoTicket(LottoTicket.of(List.of(1, 2, 3, 4, 5, 6)), LottoNumber.of(7));
		...
		LottoTickets lottoTickets = new LottoTickets(List.of(lottoTicket1, lottoTicket2, lottoTicket3, lottoTicket4, lottoTicket5, lottoTicket6, lottoTicket7, lottoTicket8));
